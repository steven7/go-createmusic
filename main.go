...
func main() {
	...
	//galleriesC := controllers.NewGalleries(services.Gallery, services.Image, r)
	//tracksCAPI := controllers.NewTracksControllerAPI(services.Track, services.Image, services.MusicFile, r)
	tracksCAPI := controllers.NewTracksControllerAPI(services.Track, services.File, r)
	...
	// r.HandleFunc("/api/tracks/edit", tracksCAPI.CreateLocalWithAPI).Methods("POST")
